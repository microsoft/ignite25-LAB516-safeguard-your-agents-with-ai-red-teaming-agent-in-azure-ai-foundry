...
1. **Open the notebook**: Navigate to `labs/2-scan-model/` and open [`2-scan-model.ipynb`](../../labs/2-scan-model/2-scan-model.ipynb)
...
!!! prompt ""
    ...
    **Ask GitHub Copilot:**
    ...
    - "How do I test an Azure OpenAI model directly without an application layer? What does a model configuration dictionary need to include?"
    - "Explain the OpenAI Chat Protocol format used for complex callbacks. What's the structure of messages arrays and how do system prompts, user messages, and assistant responses work together?"
...
**Previous Lab**: [← Lab 1: Scan Azure AI Agent](01-scan-agent.md) | **Next Lab**: [Lab 3: Cloud-Based Red Teaming →](03-scan-cloud.md)
